...
$storageAccName="store" + $uniqueString
...
Write-Host ********************* Your storage account starting to deploy *********************************
################ Storage Account ##########################

az storage account create -n $storageAccName -g $rgName --sku Standard_LRS
